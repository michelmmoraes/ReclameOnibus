...
public class TelaQueimaParadaEmbarque extends ActionBarActivity {
    TextView tvReclamacao, tvDetalhes;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_tela_queima_parada_embarque);
        ...
        tvReclamacao.setText("O motorista do ônibus "
                ...
                " não respeitou o sinal de embarque!");
